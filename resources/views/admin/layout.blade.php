                ...
                <ul class="navbar-nav ms-auto">
                            ...
                            <a href="#" class="dropdown-item">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('admins/dist/assets/img/user1-128x128.jpg') }}"
                    ...
                    <li class="nav-item dropdown user-menu">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-md-inline">Shailendra Singh</span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            ...
                            <li class="user-footer">
                               <a href="#" class="btn btn-default btn-flat m-0">Profile</a>

                                <form method="POST" action="{{ route('admin.logout') }}" class="m-0 ms-auto">
                                    @csrf
                                    <button type="submit" class="btn btn-default btn-flat m-0">
                                        Sign out
                                    </button>
                                </form>
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
            ...
            <div class="sidebar-brand">
                ...
                <a href="./index.html" class="brand-link">
                    <span class="brand-text fw-light">Dashboard | SchooLMS</span>
                </a>
                <!--end::Brand Link-->
            </div>
            <!--end::Sidebar Brand-->
