    ...
    <main class="app-main">
        ...
        <div class="app-content-header">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <h3 class="mb-0"> Update Assign Teacher</h3>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-end">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Update Assign Teacher</li>
                        </ol>
                    </div>
                </div>
                <!--end::Row-->
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card mb-4 ">
                            ...
                            <!--end::Header-->
                            <!--begin::Form-->
                            <form action="{{ route('assign-teacher.update', $assign_teachers->id) }}" method="post">
                                @csrf
                                <!--begin::Body-->
                                        ...
                                        <select name="class_id" id="class_id" class="form-control">
                                            ...
                                            @foreach ($classes as $class)
                                                <option value="{{ $class->id }}"
                                                    {{ $class->id == $assign_teachers->class_id ? 'selected' : '' }}>
                                                    {{ $class->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select name="subject_id" id="subject_id" class="form-control" id="">
                                            ...
                                            @foreach ($subjects as $subject)
                                                <option value="{{ $subject->subject->id }}"
                                                    {{ $subject->subject->id == $assign_teachers->subject_id ? 'selected' : '' }}>
                                        ...
                                        <select name="teacher_id" id="teacher_id" class="form-control" id="">
                                            ...
                                            @foreach ($teachers as $teacher)
                                                <option value="{{ $teacher->id }}"
                                                    {{ $teacher->id == $assign_teachers->teacher_id ? 'selected' : '' }}>
                                                    {{ $teacher->name }} </option>
                                            @endforeach
                                        </select>
                                        @error('teacher_id')
