        ...
        <div class="card card-outline card-primary">
            <div class="card-header mt-1 mb-1">
                ...
                <a href=""
                    ...
                    <h1 class="mb-0"><b>Admin</b> SchoolMS</h1>
                </a>
            </div>
            <div class="card-body login-card-body">
                ...
                <form action="{{ route('admin.authenticate') }}" method="post">
                    ...
                    <div class="input-group mb-0">
                        ...
                        <div class="input-group-text mb-2"><span class="bi bi-envelope"></span></div>
                    </div>
                    ...
                    <!--begin::Row-->
                    <div class="row">
                        <div class="col-8 d-inline-flex align-items-center mt-1">
